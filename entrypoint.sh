...
echo "window.DD_UI_CONFIG = {" >> /app/ui/dist/config.js
echo "  LOG_LEVEL: '${DD_UI_LOG_LEVEL:-info}'," >> /app/ui/dist/config.js
...
echo "Generated config.js with LOG_LEVEL=${DD_UI_LOG_LEVEL:-info}"
